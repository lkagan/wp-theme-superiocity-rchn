	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="hero">
			...
			<div class="vignette">
				...
				<video autoplay src="<?= get_template_directory_uri() ?>/video/inverted-silhouette2.mp4" poster="<?= get_stylesheet_directory_uri() ?>/images/inverted-silhouette-poster.jpg">
